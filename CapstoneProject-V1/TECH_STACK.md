...
Before starting the development create mock data first
...
CSV Reader Agent 
Reads and parses feedback data from CSV files 
Feedback Classifier Agent 
Categorizes feedback using NLP (bug, feature request, 
praise, complaint, spam) 
Bug Analysis Agent 
Extracts technical details: steps to reproduce, platform 
info, severity assessment 
Identifies feature requests and estimates user 
Feature Extractor Agent 
impact/demand 
Generates structured tickets and logs them to output 
Ticket Creator Agent 
CSV files 
Reviews generated tickets for completeness and 
